...
const makeAttachment = (id, filename, mimeType, author, created, size) => ({
  ...
  thumbnail: mimeType.startsWith('image/')
    ? `${BASE}/secure/thumbnail/${id}/_thumb_${id}.png`
    : undefined,
});
...
const mockIssues = [
  {
    ...
    fields: {
      ...
      project: PROJ_DASH,
      summary:
        '[DEV] Zeitreihen-Chart: Letzter Datenpunkt fehlt beim Wechsel des Zeitbereichsmodus',
      description:
      ...
      comment: wrapComments([
        makeComment(
          '12451474',
          U3,
          'Stichprobenkontrolle Anforderungsbeschreibung durchgeführt',
          '2026-03-10T13:02:44.817+0100',
        ),
      ]),
      attachment: [],
      subtasks: [],
  ...
  },
  {
    ...
    fields: {
      ...
      attachment: [
        makeAttachment(
          '1029778',
          'csv-export-fehler-screenshot.png',
          'image/png',
          U1,
          '2026-02-25T11:31:15.997+0100',
          13642,
        ),
      ],
      subtasks: [],
    ...
    fields: {
      ...
      comment: wrapComments([
        makeComment(
          '12454670',
          U4,
          'FYI [~5] – bitte mal anschauen, das betrifft auch euer Projekt.',
          '2026-03-12T15:03:20.260+0100',
        ),
      ]),
      attachment: [],
      subtasks: [],
  ...
  },
  {
    ...
    fields: {
      ...
      attachment: [
        makeAttachment(
          '1029357',
          'live-refresh-konzept.png',
          'image/png',
          U1,
          '2026-02-24T14:04:50.737+0100',
          76478,
        ),
      ],
      subtasks: [],
    ...
    fields: {
      ...
      comment: wrapComments([
        makeComment(
          '12421508',
          U4,
          'Instabilen Build-Node identifiziert, Knoten aus dem Pool entfernt, neugestartet und wieder eingebunden.',
          '2026-02-11T14:24:45.973+0100',
        ),
        makeComment(
          '12421635',
          U4,
          '[~1] Bitte eure Deployments neu ausführen.\r\n\r\n ',
          '2026-02-11T15:18:24.080+0100',
        ),
        makeComment(
          '12423685',
          U4,
          'Warten auf Feedback von [~1].',
          '2026-02-13T09:07:38.357+0100',
        ),
        makeComment(
          '12423714',
          U4,
          'Feedback von [~1]: Es funktioniert alles. Schließe das Ticket.',
          '2026-02-13T09:18:41.360+0100',
        ),
      ]),
      attachment: [
        makeAttachment(
          '1024562',
          'build-fehler-screenshot.png',
          'image/png',
          U4,
          '2026-02-11T14:22:27.310+0100',
          27141,
        ),
      ],
      subtasks: [],
  ...
  },
  {
    ...
    fields: {
      ...
      attachment: [
        makeAttachment(
          '1019655',
          'tabelle-sortierung-screenshot-1.png',
          'image/png',
          U5,
          '2026-01-29T13:54:38.790+0100',
          8754,
        ),
        makeAttachment(
          '1019656',
          'tabelle-sortierung-screenshot-2.png',
          'image/png',
          U5,
          '2026-01-29T13:55:55.600+0100',
          34323,
        ),
        makeAttachment(
          '1019657',
          'tabelle-sortierung-screenshot-3.png',
          'image/png',
          U5,
          '2026-01-29T13:57:28.927+0100',
          33016,
        ),
      ],
      subtasks: [],
  ...
  },
  {
    ...
    fields: {
      ...
      components: [
        {
          self: `${BASE}/rest/api/2/component/43980`,
          id: '43980',
          name: 'SSO-Integrations-SDK',
          description: 'Ein SDK für die Integration unternehmensweiter Single-Sign-On-Lösungen.',
        },
      ],
      comment: wrapComments([
        makeComment(
          '12418925',
          U1,
          'Umgesetzt mit SDK Version 3.0.0',
          '2026-02-09T15:25:47.777+0100',
        ),
      ]),
      attachment: [],
      subtasks: [],
