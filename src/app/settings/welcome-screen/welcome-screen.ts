...
@Component({
  ...
  template: `
    <div
      class="absolute inset-0 flex flex-col items-center justify-center overflow-y-auto"
      style="background:
           #0c0a09;
           "
    >
      ...
      <div
        ...
        style="background: radial-gradient(ellipse 100% 80% at 50% 30%, rgba(124,58,237,0.18) 0%, rgba(91,33,182,0.08) 35%, transparent 65%)"
      ></div>
      <div
        class="absolute inset-0 pointer-events-none"
        style="background: radial-gradient(ellipse 60% 50% at 20% 60%, rgba(124,58,237,0.06) 0%, transparent 60%)"
      ></div>
      <div
        class="absolute inset-0 pointer-events-none"
        style="background: radial-gradient(ellipse 50% 40% at 80% 70%, rgba(91,33,182,0.05) 0%, transparent 55%)"
      ></div>
      ...
      >
        ...
        <div
          ...
          style="width: 258px; height: 258px; top: 50%; left: 50%; transform: translate(-50%,-50%);
                    border: 1px dashed rgba(120,113,108,0.08)"
        ></div>
        ...
        >
          <div
            ...
            style="width: 6px; height: 6px; top: -3px; left: 50%; transform: translateX(-50%);
                      background: radial-gradient(circle at 35% 35%, #a8a29e 0%, #78716c 100%)"
          ></div>
        </div>
        ...
        <div
          class="absolute rounded-full"
          style="width: 3px; height: 3px; top: 20px; left: 30px; background: rgba(167,139,250,0.25)"
        ></div>
        <div
          class="absolute rounded-full"
          style="width: 4px; height: 4px; top: 200px; left: 220px; background: rgba(120,113,108,0.2)"
        ></div>
        <div
          class="absolute rounded-full"
          style="width: 3px; height: 3px; top: 80px; left: 230px; background: rgba(167,139,250,0.2)"
        ></div>
        <div
          class="absolute rounded-full"
          style="width: 4px; height: 4px; top: 180px; left: 20px; background: rgba(120,113,108,0.15)"
        ></div>
      </div>
      ...
      <div class="flex flex-col items-center text-center mt-8" style="max-width: 440px">
        <!-- Title -->
        <h1
          style="font-family: 'Nunito', sans-serif; font-size: 30px; font-weight: 800;
                    animation: orbit-fade-up 0.8s ease-out both; animation-delay: 0.3s; opacity: 0"
        >
          <span style="color: #e7e5e4">Willkommen bei </span>
          <span
            style="background: linear-gradient(135deg, #a78bfa, #c4b5fd, #a78bfa);
        ...
        <!-- Feature chips -->
        <div
          class="flex flex-wrap justify-center gap-2.5 mt-5"
          style="animation: orbit-fade-up 0.8s ease-out both; animation-delay: 0.55s; opacity: 0"
        >
          <div
            class="flex items-center gap-2 transition-all duration-150 cursor-default"
