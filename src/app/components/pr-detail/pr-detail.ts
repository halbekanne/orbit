...
@Component({
  ...
  template: `
    <article [attr.aria-label]="'PR: ' + pr().title">
      ...
      @if (pr().isDraft) {
        <div class="bg-amber-50 border-b border-amber-200 px-6 py-2.5 flex items-center gap-2" role="status">
      ...
      <section class="px-6 py-5 border-b border-stone-100" aria-labelledby="pr-jira-heading">
      ...
      <section class="px-6 py-5 border-b border-stone-100" aria-labelledby="pr-desc-heading">
      ...
      <section class="px-6 py-4 border-b border-stone-100" aria-label="Weitere Informationen">
