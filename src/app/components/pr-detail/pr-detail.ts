    ...
    <article [attr.aria-label]="(pr().isAuthoredByMe ? 'Mein PR: ' : 'PR: ') + pr().title">
      ...
      <div class="max-w-2xl mx-auto space-y-3 py-4 px-2">
        ...
        @if (settingsService.aiReviewsEnabled()) {
          ...
          <div class="bg-[var(--color-bg-card)] rounded-xl border border-[var(--color-border-subtle)] px-6 py-4 flex items-center gap-3">
            <svg class="w-5 h-5 shrink-0 text-[var(--color-text-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" />
            </svg>
            <p class="text-sm text-[var(--color-text-muted)]">KI-gestützte Reviews können in den Einstellungen aktiviert werden.</p>
          </div>
        }
