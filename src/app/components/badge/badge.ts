...
const COLOR_MAP: Record<BadgeColor, string> = {
  neutral: 'bg-[var(--color-badge-neutral-bg)] text-[var(--color-badge-neutral-text)] border-[var(--color-badge-neutral-border)]',
  primary: 'bg-[var(--color-primary-bg)] text-[var(--color-primary-text)] border-[var(--color-primary-border)]',
  ...
  signal: 'bg-[var(--color-signal-bg)] text-[var(--color-signal-text)] border-[var(--color-signal-border)]',
};
