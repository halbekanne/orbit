...
@Component({
  ...
  template: `
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
      <div class="bg-[var(--color-bg-card)] rounded-xl shadow-lg p-5 w-[320px] pointer-events-auto" (click)="$event.stopPropagation()">
        ...
        <div class="mb-3">
          <label class="text-[10px] font-medium uppercase tracking-wide text-[var(--color-text-muted)] block mb-1.5">Name</label>
          <input
            type="text"
        ...
        <div class="mb-5">
          <label class="text-[10px] font-medium uppercase tracking-wide text-[var(--color-text-muted)] block mb-1.5">Uhrzeit</label>
        ...
        <p class="text-[10px] text-[var(--color-text-muted)] text-center mt-3 select-none">Enter speichert · Esc schließt</p>
      </div>
    </div>
  `,
})
