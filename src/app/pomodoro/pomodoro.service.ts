...
export class PomodoroService {
  ...
  readonly defaultFocusMinutes = computed(
    () => this.defaults()?.focusMinutes ?? this.settingsService.pomodoroDefaults().focusMinutes,
  );
  readonly defaultBreakMinutes = computed(
    () => this.defaults()?.breakMinutes ?? this.settingsService.pomodoroDefaults().breakMinutes,
  );
