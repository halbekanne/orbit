  ...
  template: `
    @switch (overlayState()) {
      @case ('focus-end') {
        ...
        >
          <div
            class="bg-[var(--color-bg-card)] rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4 text-center"
          >
            <div
            ...
            <div
              class="bg-[var(--color-primary-bg)] rounded-lg px-4 py-2.5 mb-5 text-sm text-[var(--color-primary-text)]"
            >
              💡 {{ breakSuggestion() }}
            </div>
      ...
      @case ('break-active') {
        <div
          class="fixed inset-0 z-[60] flex flex-col items-center justify-center overflow-hidden"
        ...
        >
          ...
          <p class="relative z-10 text-xs text-violet-300/40 mb-4 tracking-widest">
            schwerelos treiben lassen …
          </p>

          <div class="relative z-10 w-40 h-[3px] bg-white/10 rounded-full mb-3 overflow-hidden">
            <div
              class="h-full bg-gradient-to-r from-violet-400 to-violet-300 rounded-full transition-[width] duration-1000 ease-linear"
          ...
          <p class="relative z-10 text-xs text-violet-300/60 mb-6">
            noch {{ breakRemainingMinutes() }} Minuten
          </p>

          <div class="relative z-10 bg-white/5 rounded-xl px-5 py-2.5 text-sm text-violet-200 mb-8">
            💡 {{ breakSuggestion() }}
          </div>
  ...
  styles: [
    `
      ...
      .star-2 {
        ...
        top: 22%;
        left: 25%;
        animation: twinkle-b 5.5s ease-in-out infinite 0.5s;
      }
      .star-3 {
        width: 3px;
        height: 3px;
        top: 6%;
        left: 42%;
        animation: twinkle-a 6s ease-in-out infinite 1s;
      }
      .star-4 {
        width: 2px;
        height: 2px;
        top: 15%;
        left: 63%;
        animation: twinkle-b 4.2s ease-in-out infinite 1.5s;
      }
      .star-5 {
        width: 3px;
        height: 3px;
        top: 10%;
        left: 78%;
        animation: twinkle-a 5s ease-in-out infinite 2s;
      }
      .star-6 {
        width: 2px;
        height: 2px;
        top: 30%;
        left: 88%;
        animation: twinkle-b 6s ease-in-out infinite 0.3s;
      }
      .star-7 {
        width: 2px;
        height: 2px;
        top: 55%;
        left: 8%;
        animation: twinkle-a 4.5s ease-in-out infinite 0.8s;
      }
      .star-8 {
        width: 3px;
        height: 3px;
        top: 65%;
        left: 18%;
        animation: twinkle-b 5s ease-in-out infinite 2.5s;
      }
      .star-9 {
        width: 2px;
        height: 2px;
        top: 60%;
        left: 82%;
        animation: twinkle-a 5.5s ease-in-out infinite 1.2s;
      }
      .star-10 {
        width: 2px;
        height: 2px;
        top: 72%;
        left: 70%;
        animation: twinkle-b 4s ease-in-out infinite 3s;
      }
      .star-11 {
        width: 3px;
        height: 3px;
        top: 40%;
        left: 93%;
        animation: twinkle-a 6.5s ease-in-out infinite 0.6s;
      }
